...
inline MTLPixelFormat to_mtl_pixel_format(TextureFormat format) {
    switch (format) {
        ...
        case TextureFormat::RGBA8UnormSrgb: return MTLPixelFormatRGBA8Unorm_sRGB;
        case TextureFormat::BGRA8Unorm: return MTLPixelFormatBGRA8Unorm;
        case TextureFormat::BGRA8UnormSrgb: return MTLPixelFormatBGRA8Unorm_sRGB;
        ...
        case TextureFormat::Depth24UnormStencil8: return MTLPixelFormatDepth24Unorm_Stencil8;
        case TextureFormat::Depth32FloatStencil8: return MTLPixelFormatDepth32Float_Stencil8;
...
inline TextureFormat from_mtl_pixel_format(MTLPixelFormat format) {
    switch (format) {
        case MTLPixelFormatR8Unorm: return TextureFormat::R8Unorm;
        ...
        case MTLPixelFormatBGRA8Unorm_sRGB: return TextureFormat::BGRA8UnormSrgb;
        ...
        case MTLPixelFormatDepth32Float_Stencil8: return TextureFormat::Depth32FloatStencil8;
...
inline MTLVertexFormat to_mtl_vertex_format(TextureFormat format) {
    switch (format) {
        case TextureFormat::R8Unorm: return MTLVertexFormatUCharNormalized;
        case TextureFormat::R8Uint: return MTLVertexFormatUChar;
        case TextureFormat::R8Sint: return MTLVertexFormatChar;
        case TextureFormat::RG8Unorm: return MTLVertexFormatUChar2Normalized;
        case TextureFormat::RGBA8Unorm: return MTLVertexFormatUChar4Normalized;
        case TextureFormat::R16Float: return MTLVertexFormatHalf;
        case TextureFormat::RG16Float: return MTLVertexFormatHalf2;
        case TextureFormat::RGBA16Float: return MTLVertexFormatHalf4;
        case TextureFormat::R32Float: return MTLVertexFormatFloat;
        case TextureFormat::RG32Float: return MTLVertexFormatFloat2;
        case TextureFormat::RGBA32Float: return MTLVertexFormatFloat4;
        case TextureFormat::R32Uint: return MTLVertexFormatUInt;
        case TextureFormat::RG32Uint: return MTLVertexFormatUInt2;
        case TextureFormat::RGBA32Uint: return MTLVertexFormatUInt4;
        case TextureFormat::R32Sint: return MTLVertexFormatInt;
        case TextureFormat::RG32Sint: return MTLVertexFormatInt2;
        case TextureFormat::RGBA32Sint: return MTLVertexFormatInt4;
