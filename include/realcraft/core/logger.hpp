...
private:
    ...
    template <typename... Args>
    static void log_impl(LogLevel level, std::string_view category, fmt::format_string<Args...> fmt, Args&&... args) {
...
#define REALCRAFT_LOG_TRACE(category, ...) ::realcraft::core::Logger::trace(category, __VA_ARGS__)

#define REALCRAFT_LOG_DEBUG(category, ...) ::realcraft::core::Logger::debug(category, __VA_ARGS__)

#define REALCRAFT_LOG_INFO(category, ...) ::realcraft::core::Logger::info(category, __VA_ARGS__)

#define REALCRAFT_LOG_WARN(category, ...) ::realcraft::core::Logger::warn(category, __VA_ARGS__)

#define REALCRAFT_LOG_ERROR(category, ...) ::realcraft::core::Logger::error(category, __VA_ARGS__)

#define REALCRAFT_LOG_CRITICAL(category, ...) ::realcraft::core::Logger::critical(category, __VA_ARGS__)
